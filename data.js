...
const DOMAINS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "site-13", cat: "기타", name: "기타 특이사항", ref: "위 항목에 없는 현장 특이사항이 있으면 아래 메모 · 사진에 기록하세요 (등급 평가는 선택)" },
    ],
  },
  {
    key: "interview",
    title: "인터뷰 영역",
    goal: "점장의 방침 이해 및 보고체계 숙지",
    items: [
      ...
      { id: "iv-7", cat: "점장", name: "현장 순회 직접 수행 이력", ref: "주 1회 이상 순회 · 결과 기록 인지" },
      { id: "iv-8", cat: "점장", name: "입고 · 발주 작업 안전수칙", ref: "자동문 끼임 · L카 동선 · 베임예방 3개 이상" },
      { id: "iv-9", cat: "점장", name: "보호구 · 안전시설 관리 권한", ref: "교체 요청 권한 · 비용 처리 절차 인지" },
    ],
  },
];
